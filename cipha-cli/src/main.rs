//! # cipha-cli
//!
//! `cipha-cli` is a CLI that supports various classifical ciphers such as ROT13, Caesar, Vigenere, Gematria and more.
//! It is an interface to the `cipha` library or crate.
//! ### Usage
//! ```bash
...
/// A simple CLI for ciphers and cryptography.
///
